...
XPSCreateController("XPS1", "newport-xps3", 5001, 3, 10, 500, 1, 500)
...
XPSCreateAxis("XPS1",0,"G2.SLZ",  "10000")
XPSCreateAxis("XPS1",1,"G2.SLX",  "10000")   
XPSCreateAxis("XPS1",2,"G2.SLT",  "10000")  
...
dbLoadRecords("$(ASYN)/db/asynRecord.db", "P=13MCC:, R=trajAsyn1, PORT=xps, ADDR=0, OMAX=300, IMAX=32000")
...
save_restoreSet_status_prefix("13MCC:")
dbLoadRecords("$(AUTOSAVE)/db/save_restoreStatus.db", "P=13MCC:")
...
dbLoadRecords("$(MOTOR)/db/motorUtil.db","P=13MCC:")

# User calc stuff
epicsEnvSet("PREFIX", "13MCC:")
< ../calc_GSECARS.iocsh
...
dbLoadRecords("$(DEVIOCSTATS)/db/iocAdminSoft.db","IOC=13MCC:")
...
create_monitor_set("auto_positions.req",5,"P=13MCC:")
# save other things every thirty seconds
create_monitor_set("auto_settings.req",30,"P=13MCC:")

# Enable user string calcs and user transforms
dbpf "13MCC:EnableUserTrans.PROC","1"
dbpf "13MCC:EnableUserSCalcs.PROC","1"
dbpf "13MCC:EnableUserACalcs.PROC","1"
dbpf "13MCC:EnableUserCalcOuts.PROC","1"
dbpf "13MCC:userStringSeqEnable","1"
