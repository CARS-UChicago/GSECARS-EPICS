...
tyGSMPFInit("serial1",  0, 0,  9600,'N',2,8,'N',"") /* SRS 570 */
tyGSMPFInit("serial2",  0, 1,  9600,'N',2,8,'N',"") /* SRS 570 */
tyGSMPFInit("serial3",  0, 2, 19200,'N',1,8,'N',"") /* Keithley 2000 */
tyGSMPFInit("serial4",  0, 3,  4800,'N',1,8,'N',"") /* Generic serial / LPC */
tyGSMPFInit("serial5",  0, 4, 19200,'N',1,8,'N',"") /* Keithley 2000 */
...
initIp330("Ip330_1",0,3,"D","-5to5",0,15,10,120)
...
##MN 12/05/04 configIp330("Ip330_1", 3,"Input",1000,0)
...
# queueSize  = size of output queue for EPICS
initIp330PID("Ip330PID1", "Ip330_1", 0, "DAC1", 1, 20)
