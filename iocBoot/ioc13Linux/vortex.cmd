...
dbLoadRecords("../../../dxp/dxpApp/Db/dxp2x.db","P=13Linux:, R=dxp1, INP=#C0 S0  @DXP1")
dbLoadRecords("../../../mca/mcaApp/Db/mca.db", "P=13Linux:,M=dxp_adc1,DTYPE=MPF MCA,INP=#C0 S0 @DXP1,NCHAN=2048")
