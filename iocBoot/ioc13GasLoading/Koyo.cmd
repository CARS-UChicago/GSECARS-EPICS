...
drvModbusAsynConfigure("K1_Xn_In_Word",  "Koyo", 4,  040400, 02,   0,  100,  "Koyo")
...
drvModbusAsynConfigure("K1_Cn_In_Word",   "Koyo", 3,  040600, 020,   0,  100, "Koyo")

# Access the same 256 bits (C0-C377) as outputs.  Function code=6.
drvModbusAsynConfigure("K1_Cn_Out_Word",  "Koyo", 6,  040600, 020,   0,  1,  "Koyo")
