...
ADSpinnakerConfig("$(PORT)", $(CAMERA_ID), 50)
...
dbpf $(PREFIX)cam1:Gain.HOPR 30

dbpf $(PREFIX)cam1:Gain.HOPR 30
dbpf $(PREFIX)cam1:GC_BalanceWhiteAuto.PROC 1
dbpf $(PREFIX)cam1:GC_BlackLevel.PROC 1
dbpf $(PREFIX)cam1:GC_AcqFrameRateAuto.PROC 1
dbpf $(PREFIX)cam1:GC_GevSCPSPacketSize.PROC 1
