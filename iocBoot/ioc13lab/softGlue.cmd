...
initIP_EP200_FPGA(1, 3, "$(SOFTGLUE)/softGlueApp/Db/SoftGlue_2_1.hex")
# SoftGlue 2.0 with octupole additions (shift registers)
#initIP_EP200_FPGA(1, 3, "$(SOFTGLUE)/softGlueApp/Db/SoftGlue_2_0_iv0x90.hex")
...
initIP_EP201("SGIO_1",1,3,1000000,0x0000,0x800000,0x90,0x00,0x00)
# bits 33-48 are outputs
initIP_EP201("SGIO_2",1,3,1000000,0x0101,0x800010,0x91,0x00,0x00)
initIP_EP201("SGIO_3",1,3,1000000,0x0101,0x800020,0x92,0x00,0x00)
...
initIP_EP201SingleRegisterPort("SOFTGLUE", 1, 3)
