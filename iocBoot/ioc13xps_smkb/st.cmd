...
dbLoadRecords("$(SSCAN)/db/scan.db", "P=13SMKB:,MAXPTS1=2000,MAXPTS2=200,MAXPTS3=20,MAXPTS4=10,MAXPTSH=10")

# Free-standing user string/number calculations (sCalcout records)
dbLoadRecords("$(CALC)/db/userStringCalcs10.db", "P=13SMKB:")

# Free-standing user transforms (transform records)
dbLoadRecords("$(CALC)/db/userTransforms10.db", "P=13SMKB:")
...
dbLoadRecords("$(AUTOSAVE)/db/save_restoreStatus.db", "P=13SMKB:")
