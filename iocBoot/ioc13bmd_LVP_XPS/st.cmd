...
XPSCreateController("XPS1", "164.54.160.4", 5001, 8, 10, 500, 1, 500)
...
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=13BMD_LVP_XPS:")
...
dbLoadRecords("$(DEVIOCSTATS)/db/iocAdminSoft.db","IOC=13BMD_LVP_XPS:")
