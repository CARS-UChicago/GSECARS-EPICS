...
# Serial 15 is connection to VME crate
...
dbLoadRecords("$(IP)/db/Digitel_stream.db",   "P=$(P), PORT=serial6,  PUMP=ip6")
dbLoadRecords("$(IP)/db/Digitel_stream.db",   "P=$(P), PORT=serial6,  PUMP=ip7")
