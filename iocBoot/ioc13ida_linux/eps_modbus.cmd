...
# Read 300 bits starting at address 100.  Function code=1. MVI46 seems to interpret start address in bits, not works.
...
dbLoadRecords("$(CARS)/db/eps_valid.template", "P=$(PREFIX)")
