...
iocshLoad ../asynIPPortConfig.cmd "PORT=serial6,  IPADDR=$(TS):4006, IEOS=,        OEOS=\\r"   # Unused      9600,'E',1,7,'N'
...
#iocshLoad ../asynIPPortConfig.cmd "PORT=serial15, IPADDR=$(TS):4015, IEOS=\\r,     OEOS=\\r"   # VME console      9600,'N',1,8,'N'
...
dbLoadRecords("$(IP)/db/Digitel.db",          "P=$(P), PORT=serial17, PUMP=ip10")
...
# Debug MKS
# asynSetTraceMask("serial5",   0, ERROR|DRIVER)
# asynSetTraceIOMask("serial5", 0, ESCAPE)
