...
# Execute the following line if you have a Vortex detector or 
# another detector with a reset pre-amplifier
dbLoadRecords("../../dxpApp/Db/dxp2x_reset.db","P=13Saturn1:med:, R=dxp1, INP=@asyn(DXP1 0)")
dbLoadRecords("../../dxpApp/Db/dxpMED.db","P=13Saturn1:med:")
# Execute the following line if you have a Ketek detector or 
# another detector with an RC pre-amplifier
#dbLoadRecords("../../dxpApp/Db/dxp2x_rc.db","P=13Saturn1:med:, R=dxp1, INP=@asyn(DXP1 0)")

# MCA record
dbLoadRecords("../../../mca/mcaApp/Db/mca.db", "P=13Saturn1:med:, M=mca1, DTYP=asynMCA,INP=@asyn(DXP1 0),NCHAN=2048")

# Setup for save_restore
< ../save_restore.cmd
save_restoreSet_status_prefix("13Saturn1:med:")
dbLoadRecords("../../../autosave/asApp/Db/save_restoreStatus.db", "P=13Saturn1:med:")
...
seq &dxpMED, "P=13Saturn1:med:, DXP=dxp, MCA=mca, N_DETECTORS=1"
