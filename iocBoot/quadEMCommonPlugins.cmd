...
NDFFTConfigure("$(PORT)_FFT2", $(QSIZE), 0, "TS1", 1)
...
NDFFTConfigure("$(PORT)_FFT3", $(QSIZE), 0, "TS1", 2
...
NDFFTConfigure("$(PORT)_FFT4", $(QSIZE), 0, "TS1", 3)
...
NDFFTConfigure("$(PORT)_FFT5", $(QSIZE), 0, "TS1", 4)
...
NDFFTConfigure("$(PORT)_FFT6", $(QSIZE), 0, "TS1", 5)
...
NDFFTConfigure("$(PORT)_FFT7", $(QSIZE), 0, "TS1", 6)
...
NDFFTConfigure("$(PORT)_FFT8", $(QSIZE), 0, "TS1", 7)
...
NDFFTConfigure("$(PORT)_FFT9", $(QSIZE), 0, "TS1", 8)
...
NDFFTConfigure("$(PORT)_FFT10", $(QSIZE), 0, "TS1", 9)
...
NDFFTConfigure("$(PORT)_FFT11", $(QSIZE), 0, "TS1", 10)
