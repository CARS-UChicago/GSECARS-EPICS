...
Hy8522AsynInit("SCALER8522", 0, 0, 88, 0, 0x1, 0, 0 )
...
dbLoadRecords("$(HY8522)/db/8522_preset.db","P=HindsXray,S=scaler1,PORT=SCALER8522,DTYP=Asyn Scaler,OUT=@asyn(SCALER8522),FREQ=25000000")	
