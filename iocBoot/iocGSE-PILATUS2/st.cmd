...
drvAsynIPPortConfigure("pilatus","gse-pilatus2:41234")
...
dbLoadRecords("$(AUTOSAVE)/asApp/Db/save_restoreStatus.db", "P=GSE-PILATUS2:")
...
create_monitor_set("auto_settings.req", 30, "P=GSE-PILATUS2:")

###
# Start the SNL program
seq(pilatusROIs, "DET=GSE-PILATUS2:, PORT=pilatus, NROIS=16")
