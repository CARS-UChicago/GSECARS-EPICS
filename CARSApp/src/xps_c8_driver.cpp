...
#define DLL_VERSION "Library version for XPS-C8 Firmware V0.3.07.01 BETA"
...
/***********************************************************************/ 
int __stdcall GPIOAnalogGainGet (int SocketIndex, int NbElements, char * GPIONameList, short AnalogInputGainValue[]) 
{ 
	int ret = -1; 
	char ExecuteMethod [SIZE_BUFFER]; 
	char ReturnedValue [SIZE_BUFFER]; 
	...
	for (int i = 0; i < NbElements; i++)
	{
		sprintf (temp, "%s,short *", stringArray0[i]);
		strcat (ExecuteMethod, temp);
		if ((i + 1) < NbElements) 
		{
			strcat (ExecuteMethod, ",");
	...
	{ 
		...
		for (int i = 0; i < NbElements; i++)
		{
			if (pt != NULL) pt = strchr (pt, ',');
			if (pt != NULL) pt++;
			if (pt != NULL) sscanf (pt, "%hd", &AnalogInputGainValue[i]);
		}
	} 
	return (ret); 
}
...
/***********************************************************************/ 
int __stdcall GPIOAnalogGainSet (int SocketIndex, int NbElements, char * GPIONameList, short AnalogInputGainValue[]) 
{ 
	int ret = -1; 
	char ExecuteMethod [SIZE_BUFFER]; 
	char ReturnedValue [SIZE_BUFFER]; 
...
/***********************************************************************/ 
int __stdcall GPIODigitalGet (int SocketIndex, char * GPIOName, short * DigitalValue) 
{ 
	int ret = -1; 
	char ExecuteMethod [SIZE_BUFFER]; 
	char ReturnedValue [SIZE_BUFFER]; 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "GPIODigitalGet (%s,short *)", GPIOName);
	...
	{ 
		...
		if (pt != NULL) pt = strchr (pt, ',');
		if (pt != NULL) pt++;
		if (pt != NULL) sscanf (pt, "%hd", DigitalValue);
	} 
	return (ret); 
}
...
/***********************************************************************/ 
int __stdcall GPIODigitalSet (int SocketIndex, char * GPIOName, short Mask, short DigitalOutputValue) 
{ 
	int ret = -1; 
	char ExecuteMethod [SIZE_BUFFER]; 
	char ReturnedValue [SIZE_BUFFER]; 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "GPIODigitalSet (%s,%d,%d)", GPIOName, Mask, DigitalOutputValue);
...
{ 
	...
	{ 
		...
		if (pt != NULL) pt = strchr (pt, ',');
		if (pt != NULL) pt++;
		if (pt != NULL) sscanf (pt, "%d", (int *)ClosedLoopStatus);
		if (pt != NULL) pt = strchr (pt, ',');
		if (pt != NULL) pt++;
...
/***********************************************************************/ 
int __stdcall PositionerCorrectorTypeGet (int SocketIndex, char * PositionerName, char * CorretorType) 
{ 
	int ret = -1; 
	char ExecuteMethod [SIZE_BUFFER]; 
	char ReturnedValue [SIZE_BUFFER]; 
	...
	{ 
		...
		if (pt != NULL) pt = strchr (pt, ',');
		if (pt != NULL) pt++;
		if (pt != NULL) strcpy (CorretorType, pt);
		ptNext = strchr (CorretorType, ',');
		if (ptNext != NULL) *ptNext = '\0';
	} 
	return (ret); 
}
...
{ 
	...
	{ 
		...
		if (pt != NULL) pt = strchr (pt, ',');
		if (pt != NULL) pt++;
		if (pt != NULL) sscanf (pt, "%d", (int *)EnableState);
	} 
	return (ret); 
}
...
/***********************************************************************/ 
int __stdcall UserDatasGet (int SocketIndex, double * UserData1, double * UserData2, double * UserData3, double * UserData4, double * UserData5, double * UserData6, double * UserData7, double * UserData8) 
{ 
	int ret = -1; 
	char ExecuteMethod [SIZE_BUFFER]; 
	char ReturnedValue [SIZE_BUFFER]; 
	...
	/* Convert to string */ 
	sprintf (ExecuteMethod, "UserDatasGet (double *,double *,double *,double *,double *,double *,double *,double *)");
